...
const dzireSlidersdata = [
  {
    original: require('../../../assets/dzire/1.webp'),
    thumbnail: require('../../../assets/dzire/1.webp'),
  },
  {
    original: require('../../../assets/dzire/2.webp'),
    thumbnail: require('../../../assets/dzire/2.webp'),
  },
  {
    original: require('../../../assets/dzire/3.webp'),
    thumbnail: require('../../../assets/dzire/3.webp'),
  },
  {
    original: require('../../../assets/dzire/4.webp'),
    thumbnail: require('../../../assets/dzire/4.webp'),
  },
  {
    original: require('../../../assets/dzire/5.webp'),
    thumbnail: require('../../../assets/dzire/5.webp'),
  },
  {
    original: require('../../../assets/dzire/6.webp'),
    thumbnail: require('../../../assets/dzire/6.webp'),
  },
  {
    original: require('../../../assets/dzire/7.webp'),
    thumbnail: require('../../../assets/dzire/7.webp'),
  },
  {
    original: require('../../../assets/dzire/8.webp'),
    thumbnail: require('../../../assets/dzire/8.webp'),
  },
  {
    original: require('../../../assets/dzire/9.webp'),
    thumbnail: require('../../../assets/dzire/9.webp'),
  },
  {
    original: require('../../../assets/dzire/10.webp'),
    thumbnail: require('../../../assets/dzire/10.webp'),
  },
];
...
const dzireColors = [
  {
    id: 1,
    img: require('../../../assets/dzire/colors/DzireWhitemerged-v4.webp'),
  },
  {
    id: 2,
    img: require('../../../assets/dzire/colors/DzireSilkySilvermerged-v6.webp'),
  },
  {
    id: 3,
    img: require('../../../assets/dzire/colors/DzireSherwoodBrownmerged-v5.webp'),
  },
  {
    id: 4,
    img: require('../../../assets/dzire/colors/DzireOxfordBluemergednewblack-v3.webp'),
  },
  {
    id: 5,
    img: require('../../../assets/dzire/colors/DzireMagmaGreymerged-v2.webp'),
  },
  {
    id: 6,
    img: require('../../../assets/dzire/colors/DzireGallantRedmerged-v1.webp'),
  },
];
...
function Dzire() {
  return (
    <>
      ...
      <Helmet>
        <title>
          Maruti Suzuki Dzire On Road Price in Uttar Pradesh | Smartwheels
        </title>
        <meta
          name='title'
          content='Maruti Suzuki Dzire On Road Price in Uttar Pradesh | Smartwheels'
        />
        <meta
          name='description'
          content='Maruti Suzuki Swift on road price in Uttar Pradesh starts at ₹6.24 Lakh. Dzire features and specification. For more Maruti Dzire offers & discounts visit Smartwheels showroom today.'
        />
      </Helmet>
          ...
          <div className='flex justify-between text-[#1a3760] mx-5 lg:mx-0'>
            ...
            <div>
              <p className='text-xl lg:text-2xl font-bold'>
                <span className='text-xs'>Starts at</span> ₹ 6.24 Lakh*
              </p>
      ...
      <div className='container mx-auto py-4'>
        <img
          src={require('../../../assets/brochures/arena/dzire-brochure.webp')}
          alt='dzire brochure'
        />
      </div>
    </>
  ...
  return (
    <div className=' bg-white text-[#1a3760] border border-gray-200 shadow-sm rounded-lg p-7'>
      ...
      <div className='flex items-center justify-between mt-8 border-b pb-2'>
        ...
        <p className='text-sm font-normal text-gray-700'>Dzire</p>
      </div>
      ...
      <div className='flex items-center justify-between mt-5 pb-2'>
        ...
        <p className='text-sm font-normal text-gray-700'>378 L</p>
      </div>
    </div>
  );
};
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mt-3'>
          ...
          >
            ...
            <option value='Dzire LXI 1.2L 5MT'>Dzire LXI 1.2L 5MT</option>
            <option value='Dzire LXI 1.2L 5MT'>Dzire LXI 1.2L 5MT</option>
            <option value='Dzire LXI 1.2L 5MT'>Dzire LXI 1.2L 5MT</option>
            <option value='Dzire LXI 1.2L 5MT'>Dzire LXI 1.2L 5MT</option>
            <option value='Dzire VXI CNG'>Dzire VXI CNG</option>
            <option value='Dzire ZXI 1.2L AGS'>Dzire ZXI 1.2L AGS</option>
            <option value='Dzire ZXI+ 1.2L 5MT'>Dzire ZXI+ 1.2L 5MT</option>
            <option value='Dzire ZXI CNG'>Dzire ZXI CNG</option>
            <option value='Dzire ZXI+ 1.2L AGS'>Dzire ZXI+ 1.2L AGS</option>
          </select>
        </div>
...
const Colors = () => {
  ...
  return (
    <div className='container mx-auto bg-gray-200 rounded py-8 px-5'>
      <div className='flex justify-end pr-6'>
        <a
          href={require('../../../assets/brochures/arena/Dzire_Revised_Product_Brochure.pdf')}
      ...
      <div className='flex items-center justify-center space-x-3 sm:space-y-0 space-y-1'>
        ...
        <p
          className={
            current === 4
              ? 'h-5 rounded-full w-5 bg-[#083281] animate-bounce'
              : 'h-5 rounded-full w-5 bg-[#083281]'
          }
        ...
        <p
          className={
            current === 5
              ? 'h-5 rounded-full w-5 bg-[#938d87] animate-bounce'
              : 'h-5 rounded-full w-5 bg-[#938d87]'
          }
        ...
        <p
          className={
            current === 6
              ? 'h-5 rounded-full w-5 bg-[#741605] animate-bounce'
              : 'h-5 rounded-full w-5 bg-[#741605]'
          }
