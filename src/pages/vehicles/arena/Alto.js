...
const altoSliders = [
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Exterior.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Exterior.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Front-Left-View-Angle.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Front-Left-View-Angle.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Front-View.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Front-View.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Headlight.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Headlight.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Interior.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Interior.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Passenger-View.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Passenger-View.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Seats.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Seats.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Steering.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Steering.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Alto-Wheel.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Alto-Wheel.webp'),
  },
  {
    original: require('../../../assets/alto/Maruti-Suzuki-Window-Line.webp'),
    thumbnail: require('../../../assets/alto/Maruti-Suzuki-Window-Line.webp'),
  },
];
...
const altoColors = [
  {
    id: 1,
    img: require('../../../assets/alto/colors/Maruti-Suzuki-Alto800-Blazing-Red.webp'),
  },
  {
    id: 2,
    img: require('../../../assets/alto/colors/Maruti-Suzuki-Alto800-Cerulean-BLue.webp'),
  },
  {
    id: 3,
    img: require('../../../assets/alto/colors/Maruti-Suzuki-Alto800-Granite-GREY.webp'),
  },
  {
    id: 4,
    img: require('../../../assets/alto/colors/Maruti-Suzuki-Alto800-Mojito-Green.webp'),
  },
  {
    id: 5,
    img: require('../../../assets/alto/colors/Maruti-Suzuki-Alto800-Silky-Silver.webp'),
  },
  {
    id: 6,
    img: require('../../../assets/alto/colors/Maruti-Suzuki-Alto800-Superior-White.webp'),
  },
];
...
function Alto() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          Maruti Suzuki Alto On Road Price in Uttar Pradesh | Smartwheels
        </title>
        <meta
          name='title'
          content='  Maruti Suzuki Alto On Road Price in Uttar Pradesh | Smartwheels'
        />
        <meta
          name='description'
          content='New Maruti Suzuki Alto on road price in Uttar Pradesh starts at ₹3.39 Lakh. Alto features and specification. For more Maruti Alto offers & discounts visit Smartwheels showroom today.'
        />
      </Helmet>
          ...
          <div className='flex justify-between text-[#1a3760] mx-5 lg:mx-0'>
            ...
            <div>
              <p className='text-xl lg:text-2xl font-bold'>
                <span className='text-xs'>Starts at</span> ₹ 3.39 Lakh*
              </p>
      ...
      <div className='bg-white container mx-auto py-9'>
        <img
          src={require('../../../assets/brochures/arena/alto-brochure.webp')}
          alt='alto brochure'
        />
      </div>
    </>
  ...
  return (
    <div className=' bg-white text-[#1a3760] border border-gray-200 shadow-sm rounded-lg p-7'>
      ...
      <div className='flex items-center justify-between mt-5 border-b pb-2'>
        ...
        <p className='text-sm font-normal text-gray-700'>35 L or 60 kgs</p>
      </div>
      ...
      <div className='flex items-center justify-between mt-5 border-b pb-2'>
        ...
        <p className='text-sm font-normal text-gray-700'>22.05 kmpl*</p>
      </div>

      <div className='flex items-center justify-between mt-5 pb-2'>
        <p className='font-semibold text-sm text-[#1a3760]'>CNG Mileage:</p>
        <p className='text-sm font-normal text-gray-700'>31.59 km/kg*</p>
      </div>
    </div>
  );
};
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mt-3'>
          ...
          >
            ...
            <option value='Alto STD (O)'>Alto STD (O)</option>
            <option value='Alto LXI (O)'>Alto LXI (O)</option>
            <option value='Alto VXI'>Alto VXI</option>
            <option value='Alto VXI+'>Alto VXI+</option>
            <option value='Alto LXI (O) CNG'>Alto LXI (O) CNG</option>
          </select>
        </div>
  ...
  return (
    <div className='container mx-auto bg-gray-100 rounded py-8'>
      <div className='flex justify-end pr-6'>
        <a
          href={require('../../../assets/brochures/arena/Alto_Brand_Brochure.pdf')}
      ...
      <div className='flex items-center justify-center space-x-3 sm:space-y-0 space-y-1'>
        ...
        <p
          className={
            current === 4
              ? 'h-5 rounded-full w-5 bg-[#d7e9ab] animate-bounce'
              : 'h-5 rounded-full w-5 bg-[#d7e9ab]'
          }
