...
const tourmSlidersdata = [
  {
    original: require('../../../assets/commercial/tourm/Tour-M_car1.png'),
    thumbnail: require('../../../assets/commercial/tourm/Tour-M_car1.png'),
  },

  {
    original: require('../../../assets/commercial/tourm/Tour-M_car.png'),
    thumbnail: require('../../../assets/commercial/tourm/Tour-M_car.png'),
  },

  {
    original: require('../../../assets/commercial/tourm/Tour-M_Exterior_01.png'),
    thumbnail: require('../../../assets/commercial/tourm/Tour-M_Exterior_01.png'),
  },
  {
    original: require('../../../assets/commercial/tourm/Tour-M_Interior_01.png'),
    thumbnail: require('../../../assets/commercial/tourm/Tour-M_Interior_01.png'),
  },
  {
    original: require('../../../assets/commercial/tourm/Tour-M_Interior_02.png'),
    thumbnail: require('../../../assets/commercial/tourm/Tour-M_Interior_02.png'),
  },
];
...
function TourM() {
  return (
    <>
      ...
      <Helmet>
        <title>
          Maruti Suzuki Tour M On Road Price in Uttar Pradesh | Commercial
          Ertiga Car
        </title>
        <meta
          name='title'
          content='Maruti Suzuki Tour M On Road Price in Uttar Pradesh | Commercial Ertiga Car'
        />
        <meta
          name='description'
          content='Maruti Suzuki Ertiga Tour M commercial on road price in Uttar Pradesh. It is available in petrol and CNG engine options. Check mileage, performance, specifications, interior, and exterior of Tour M Commercial at Smartwheels Commercial Showroom.'
        />
      </Helmet>
          ...
          <div className='flex justify-between text-[#1a3760] mx-5 lg:mx-0'>
            ...
            <div>
              <p className='text-xl lg:text-2xl font-bold'>
                <span className='text-xs'>Starts at</span> ₹ 8.29 Lakh*
              </p>
  ...
  return (
    <div className=' bg-white text-[#1a3760] border border-gray-200 shadow-sm rounded-lg p-7'>
      ...
      <div className='flex items-center justify-between mt-5 border-b pb-2'>
        ...
        <p className='text-sm font-normal text-gray-700'>45 L (Petrol)</p>
      </div>

      <div className='flex items-center justify-between mt-5 border-b pb-2'>
        <p className='font-semibold text-sm text-[#1a3760]'>Engine Type:</p>
        <p className='text-sm font-normal text-gray-700'>K15B</p>
      </div>
      ...
      <div className='flex items-center justify-between mt-5 pb-2'>
        ...
        <p className='text-sm font-normal text-gray-700'>1235 KG</p>
      </div>
    </div>
  );
};
